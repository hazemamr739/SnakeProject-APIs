...
namespace SnakeProject.Infrastructure.Migrations
{
    ...
    [Migration("20260329110731_SyncIdentityRoleContext")]
    partial class SyncIdentityRoleContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SnakeProject.Domain.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SnakeProject.Domain.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SnakeProject.Domain.Entities.ApplicationUser", b =>
                {
                    b.OwnsMany("SnakeProject.Domain.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
